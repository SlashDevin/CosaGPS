...
* [CosaNMEA](examples/CosaNMEA/CosaNMEA.ino) - sync, polled, single, standard NMEA only
...
* [CosaNMEAtest.ino](examples/CosaNMEAtest/CosaNMEAtest.ino) - sync, polled, not fused, standard NMEA only
